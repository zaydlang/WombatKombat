// Generated by Haxe 3.4.0 (git build master @ 36ebffa)
...
Main.__name__ = true;
Main.main = function() {
	n4_NGame.init("Wombat Combat",1024,768,states_IntroState);
};
Math.__name__ = true;
...
var kha_BlobList = function() {
	this.names = ["OFL_txt"];
	this.OFL_txtDescription = { files : ["OFL.txt"], type : "blob", name : "OFL_txt"};
	this.OFL_txtName = "OFL_txt";
	this.OFL_txt = null;
};
...
kha_BlobList.prototype = {
	OFL_txt: null
	,OFL_txtName: null
	,OFL_txtDescription: null
	,OFL_txtLoad: function(done) {
		kha_Assets.loadBlob("OFL_txt",function(blob) {
			done();
		});
	}
	,OFL_txtUnload: function() {
		this.OFL_txt.unload();
		this.OFL_txt = null;
	}
	,names: null
...
var kha_FontList = function() {
	...
	this.Raleway_SemiBoldItalicDescription = { files : ["Raleway-SemiBoldItalic.ttf"], type : "font", name : "Raleway_SemiBoldItalic"};
	this.Raleway_SemiBoldItalicName = "Raleway_SemiBoldItalic";
	this.Raleway_SemiBoldItalic = null;
	this.Raleway_SemiBoldDescription = { files : ["Raleway-SemiBold.ttf"], type : "font", name : "Raleway_SemiBold"};
	this.Raleway_SemiBoldName = "Raleway_SemiBold";
	this.Raleway_SemiBold = null;
	this.Raleway_RegularDescription = { files : ["Raleway-Regular.ttf"], type : "font", name : "Raleway_Regular"};
	this.Raleway_RegularName = "Raleway_Regular";
	this.Raleway_Regular = null;
...
kha_FontList.prototype = {
	...
	,Raleway_BlackLoad: function(done) {
		kha_Assets.loadFont("Raleway_Black",function(font) {
			done();
		});
	}
	...
	,Raleway_BoldDescription: null
	,Raleway_BoldLoad: function(done) {
		kha_Assets.loadFont("Raleway_Bold",function(font) {
			done();
		});
	}
	,Raleway_BoldUnload: function() {
		this.Raleway_Bold.unload();
		this.Raleway_Bold = null;
	}
	,Raleway_BoldItalic: null
	,Raleway_BoldItalicName: null
	,Raleway_BoldItalicDescription: null
	,Raleway_BoldItalicLoad: function(done) {
		kha_Assets.loadFont("Raleway_BoldItalic",function(font) {
			done();
		});
	}
	,Raleway_BoldItalicUnload: function() {
	...
	,Raleway_ExtraBoldItalicLoad: function(done) {
		kha_Assets.loadFont("Raleway_ExtraBoldItalic",function(font) {
			done();
		});
	}
	,Raleway_ExtraBoldItalicUnload: function() {
	...
	,Raleway_ExtraLightDescription: null
	,Raleway_ExtraLightLoad: function(done) {
		kha_Assets.loadFont("Raleway_ExtraLight",function(font) {
			done();
		});
	}
	,Raleway_ExtraLightUnload: function() {
		this.Raleway_ExtraLight.unload();
		this.Raleway_ExtraLight = null;
	}
	,Raleway_ExtraLightItalic: null
	,Raleway_ExtraLightItalicName: null
	,Raleway_ExtraLightItalicDescription: null
	,Raleway_ExtraLightItalicLoad: function(done) {
		kha_Assets.loadFont("Raleway_ExtraLightItalic",function(font) {
			done();
		});
	}
	,Raleway_ExtraLightItalicUnload: function() {
	...
	,Raleway_LightLoad: function(done) {
		kha_Assets.loadFont("Raleway_Light",function(font) {
			done();
		});
	}
	,Raleway_LightUnload: function() {
	...
	,Raleway_LightItalicLoad: function(done) {
		kha_Assets.loadFont("Raleway_LightItalic",function(font) {
			done();
		});
	}
	...
	,Raleway_MediumItalicDescription: null
	,Raleway_MediumItalicLoad: function(done) {
		kha_Assets.loadFont("Raleway_MediumItalic",function(font) {
			done();
		});
	}
	,Raleway_MediumItalicUnload: function() {
		this.Raleway_MediumItalic.unload();
		this.Raleway_MediumItalic = null;
	}
	,Raleway_Regular: null
	,Raleway_RegularName: null
	,Raleway_RegularDescription: null
	,Raleway_RegularLoad: function(done) {
		kha_Assets.loadFont("Raleway_Regular",function(font) {
			done();
		});
	}
	,Raleway_RegularUnload: function() {
		this.Raleway_Regular.unload();
		this.Raleway_Regular = null;
	}
	,Raleway_SemiBold: null
	,Raleway_SemiBoldName: null
	,Raleway_SemiBoldDescription: null
	,Raleway_SemiBoldLoad: function(done) {
		kha_Assets.loadFont("Raleway_SemiBold",function(font) {
			done();
		});
	}
	,Raleway_SemiBoldUnload: function() {
		this.Raleway_SemiBold.unload();
		this.Raleway_SemiBold = null;
	}
	,Raleway_SemiBoldItalic: null
	,Raleway_SemiBoldItalicName: null
	,Raleway_SemiBoldItalicDescription: null
	,Raleway_SemiBoldItalicLoad: function(done) {
		kha_Assets.loadFont("Raleway_SemiBoldItalic",function(font) {
			done();
		});
	}
	,Raleway_SemiBoldItalicUnload: function() {
		this.Raleway_SemiBoldItalic.unload();
		this.Raleway_SemiBoldItalic = null;
	}
	,Raleway_Thin: null
	,Raleway_ThinName: null
	,Raleway_ThinDescription: null
	,Raleway_ThinLoad: function(done) {
		kha_Assets.loadFont("Raleway_Thin",function(font) {
			done();
		});
	}
	,Raleway_ThinUnload: function() {
	...
	,RalewayLoad: function(done) {
		kha_Assets.loadFont("Raleway",function(font) {
			done();
		});
	}
	...
	while(_g8 < _g17.length) {
		...
		if(StringTools.endsWith(sound1[0],"Load")) {
			(Reflect.field(kha_Assets.sounds,sound1[0]))((function(sound2) {
				return function() {
					Reflect.field(kha_Assets.sounds,sound2[0].substring(0,sound2[0].length - 4)).uncompress((function() {
						return function() {
							filesLeft -= 1;
							kha_Assets.progress = 1 - filesLeft / fileCount;
							if(filesLeft == 0) {
...
kha_SystemImpl.initEx = function(title,options,windowCallback,callback) {
	haxe_Log.trace("initEx is not supported on the html5 target, running init() with first window options",{ fileName : "SystemImpl.hx", lineNumber : 83, className : "kha.SystemImpl", methodName : "initEx"});
...
kha_SystemImpl.windowWidth = function(windowId) {
	...
	if(kha_SystemImpl.loaded) {
		return kha_SystemImpl.khanvas.width;
	} else if(kha_SystemImpl.options.width != null) {
...
kha_SystemImpl.windowHeight = function(windowId) {
	...
	} else if(kha_SystemImpl.options.height != null) {
...
kha_SystemImpl.loadFinished = function() {
	...
	try {
		...
		haxe_Log.trace(e,{ fileName : "SystemImpl.hx", lineNumber : 325, className : "kha.SystemImpl", methodName : "loadFinished"});
	}
...
kha_SystemImpl.mouseDown = function(event) {
	...
	if(event.which == 1) {
		...
		if(Object.prototype.hasOwnProperty.call(kha_SystemImpl.khanvas,"setCapture")) {
...
kha_SystemImpl.mouseLeftUp = function(event) {
	...
	if(Object.prototype.hasOwnProperty.call(o,"releaseCapture")) {
...
kha_audio2_ogg_vorbis_Reader.readAll = function(bytes,output,useFloat) {
	...
	while(true) {
		...
		while(_g1 < _g) output.writeFloat(buffer[_g1++]);
		if(n == 0) {
			break;
		}
		count += n;
...
kha_graphics2_Graphics.prototype = {
	...
	,rotate: function(angle,centerx,centery) {
		...
		this.transformations[this.transformations.length - 1]._00 = _002 * m._00 + _102 * m._01 + _201 * m._02;
		this.transformations[this.transformations.length - 1]._01 = _013;
		this.transformations[this.transformations.length - 1]._02 = _022;
		this.transformations[this.transformations.length - 1]._10 = _002 * m._10 + _102 * m._11 + _201 * m._12;
		this.transformations[this.transformations.length - 1]._11 = _113;
		this.transformations[this.transformations.length - 1]._12 = _122;
		this.transformations[this.transformations.length - 1]._20 = _002 * m._20 + _102 * m._21 + _201 * m._22;
		this.transformations[this.transformations.length - 1]._21 = _212;
		this.transformations[this.transformations.length - 1]._22 = _222;
	}
...
kha_graphics2_truetype_StbTruetype.stbtt_GetFontOffsetForIndex = function(font_collection,index) {
	...
	if(font_collection.readU8(0) == c0 && font_collection.readU8(1) == c1 && font_collection.readU8(2) == c2 && font_collection.readU8(3) == c3) {
		if((font_collection.readU8(7) | font_collection.readU8(6) << 8 | font_collection.readU8(5) << 16 | font_collection.readU8(4) << 24) == 65536 || (font_collection.readU8(7) | font_collection.readU8(6) << 8 | font_collection.readU8(5) << 16 | font_collection.readU8(4) << 24) == 131072) {
			...
			var pos = 12 + index * 4;
			return font_collection.readU8(pos + 3) | font_collection.readU8(pos + 2) << 8 | font_collection.readU8(pos + 1) << 16 | font_collection.readU8(pos) << 24;
		}
	}
	return -1;
};
kha_graphics2_truetype_StbTruetype.stbtt_InitFont = function(info,data,fontstart) {
	...
	var pos1 = cmap + 2;
	numTables = data.readU8(pos1 + 1) | data.readU8(pos1) << 8;
	info.index_map = 0;
	var _g1 = 0;
	while(_g1 < numTables) {
...
kha_graphics2_truetype_StbTruetype.stbtt_FindGlyphIndex = function(info,unicode_codepoint) {
	...
	if(format == 0) {
		...
		while(entrySelector != 0) {
			...
			end = data.readU8(pos9 + 1) | data.readU8(pos9) << 8;
		...
		start = data.readU8(pos11 + 1) | data.readU8(pos11) << 8;
		if(unicode_codepoint < start) {
			return 0;
		}
		var pos12 = index_map + 14 + segcount * 6 + 2 + 2 * item;
		offset = data.readU8(pos12 + 1) | data.readU8(pos12) << 8;
		if(offset == 0) {
		...
		var high;
		low = 0;
		high = data.readU8(pos15 + 3) | data.readU8(pos15 + 2) << 8 | data.readU8(pos15 + 1) << 16 | data.readU8(pos15) << 24;
		while(low < high) {
...
kha_graphics2_truetype_StbTruetype.stbtt_IsGlyphEmpty = function(info,glyph_index) {
	...
	var p = info.data;
	var n = p.readU8(g + 1) | p.readU8(g) << 8;
	if((n & 32768) != 0) {
	...
	if(numberOfContours > 0) {
		...
		while(_g12 < _g3) {
			...
			if((flags & 2) != 0) {
				...
				var value;
				var n2 = points.readU8(pointsIndex + 1) | points.readU8(pointsIndex) << 8;
				if((n2 & 32768) != 0) {
					value = n2 - 65536;
				} else {
					value = n2;
		...
		while(_g13 < _g4) {
			...
			if((flags & 4) != 0) {
				...
				var value1;
				var n3 = points.readU8(pointsIndex + 1) | points.readU8(pointsIndex) << 8;
				if((n3 & 32768) != 0) {
					value1 = n3 - 65536;
				} else {
					value1 = n3;
		...
		while(i3 < n1) {
			...
			if(next_move == i3) {
				...
				was_off = false;
				var pos2 = j * 2;
				next_move = 1 + (endPtsOfContours.readU8(pos2 + 1) | endPtsOfContours.readU8(pos2) << 8);
				++j;
			} else if((flags & 1) == 0) {
				if(was_off) {
		...
		while(more != 0) {
			...
			var m1;
			var n4;
			var n5 = comp.readU8(compIndex + 1) | comp.readU8(compIndex) << 8;
			if((n5 & 32768) != 0) {
				flags1 = n5 - 65536;
			} else {
				flags1 = n5;
			...
			compIndex += 2;
			var n6 = comp.readU8(compIndex + 1) | comp.readU8(compIndex) << 8;
			if((n6 & 32768) != 0) {
				gidx = n6 - 65536;
			} else {
				gidx = n6;
			...
			if((flags1 & 2) != 0) {
				if((flags1 & 1) != 0) {
					var n7 = comp.readU8(compIndex + 1) | comp.readU8(compIndex) << 8;
					if((n7 & 32768) != 0) {
						mtx4 = n7 - 65536;
					} else {
						mtx4 = n7;
					...
					compIndex += 2;
					var n8 = comp.readU8(compIndex + 1) | comp.readU8(compIndex) << 8;
					if((n8 & 32768) != 0) {
						mtx5 = n8 - 65536;
					} else {
						mtx5 = n8;
			...
			if((flags1 & 8) != 0) {
				var n11 = comp.readU8(compIndex + 1) | comp.readU8(compIndex) << 8;
				...
				var n12 = comp.readU8(compIndex + 1) | comp.readU8(compIndex) << 8;
				mtx0 = ((n12 & 32768) != 0 ? n12 - 65536 : n12) / 16384.0;
				compIndex += 2;
				mtx2 = 0;
				mtx1 = mtx2;
				var n13 = comp.readU8(compIndex + 1) | comp.readU8(compIndex) << 8;
				mtx3 = ((n13 & 32768) != 0 ? n13 - 65536 : n13) / 16384.0;
				compIndex += 2;
			} else if((flags1 & 128) != 0) {
				var n14 = comp.readU8(compIndex + 1) | comp.readU8(compIndex) << 8;
				mtx0 = ((n14 & 32768) != 0 ? n14 - 65536 : n14) / 16384.0;
				compIndex += 2;
				var n15 = comp.readU8(compIndex + 1) | comp.readU8(compIndex) << 8;
				mtx1 = ((n15 & 32768) != 0 ? n15 - 65536 : n15) / 16384.0;
				compIndex += 2;
				var n16 = comp.readU8(compIndex + 1) | comp.readU8(compIndex) << 8;
				mtx2 = ((n16 & 32768) != 0 ? n16 - 65536 : n16) / 16384.0;
				compIndex += 2;
				var n17 = comp.readU8(compIndex + 1) | comp.readU8(compIndex) << 8;
...
kha_graphics2_truetype_StbTruetype.stbtt_GetGlyphKernAdvance = function(info,glyph1,glyph2) {
	...
	if((data.readU8(3) | data.readU8(2) << 8) < 1) {
		return 0;
	}
	if((data.readU8(9) | data.readU8(8) << 8) != 1) {
		return 0;
	}
	l = 0;
	r = (data.readU8(11) | data.readU8(10) << 8) - 1;
	needle = glyph1 << 16 | glyph2;
	while(l <= r) {
		m = l + r >> 1;
		var pos = 18 + m * 6;
		straw = data.readU8(pos + 3) | data.readU8(pos + 2) << 8 | data.readU8(pos + 1) << 16 | data.readU8(pos) << 24;
		if(needle < straw) {
			r = m - 1;
			...
			var pos1 = 22 + m * 6;
			var n = data.readU8(pos1 + 1) | data.readU8(pos1) << 8;
			if((n & 32768) != 0) {
				return n - 65536;
			} else {
				return n;
...
kha_graphics4_Graphics2.prototype = $extend(kha_graphics2_Graphics.prototype,{
	...
	,fillTriangle: function(x1,y1,x2,y2,x3,y3) {
		...
		this.coloredPainter.fillTriangle(this.get_opacity(),this.get_color(),(_this._00 * x1 + _this._10 * y1 + _this._20) / w,(_this._01 * x1 + _this._11 * y1 + _this._21) / w,(_this1._00 * x2 + _this1._10 * y2 + _this1._20) / w1,(_this1._01 * x2 + _this1._11 * y2 + _this1._21) / w1,(_this2._00 * x3 + _this2._10 * y3 + _this2._20) / w2,(_this2._01 * x3 + _this2._11 * y3 + _this2._21) / w2);
	}
...
kha_graphics4_IndexBuffer.prototype = {
	...
	,unlock: function() {
		...
		var glData = kha_SystemImpl.elementIndexUint == null ? new Uint16Array(this.data) : new Uint32Array(this.data);
...
kha_js_CanvasGraphics.prototype = $extend(kha_graphics2_Graphics.prototype,{
	...
	,drawString: function(text,x,y) {
		...
		if(image.width > 0) {
			...
			var _g = text.length;
			while(_g1 < _g) {
				var q = this.webfont.kravur._get(this.get_fontSize()).getBakedQuad(HxOverrides.cca(text,_g1++) - 32,xpos,y);
				if(q != null) {
...
kha_js_Font.prototype = {
	...
	,getImage: function(fontSize,color) {
		if(!this.images.h.hasOwnProperty(fontSize)) {
			this.images.h[fontSize] = new haxe_ds_IntMap();
		}
...
kha_js_graphics4_Graphics.prototype = {
	...
	,drawIndexedVertices: function(start,count) {
		...
		kha_SystemImpl.gl.drawElements(4,count == -1 ? this.indicesCount : count,kha_SystemImpl.elementIndexUint == null ? 5123 : 5125,start * 2);
	}
	...
	,drawIndexedVerticesInstanced: function(instanceCount,start,count) {
		...
		if(this.instancedRenderingAvailable()) {
			this.instancedExtension.drawElementsInstancedANGLE(4,count == -1 ? this.indicesCount : count,kha_SystemImpl.elementIndexUint == null ? 5123 : 5125,start * 2,instanceCount);
		}
	}
...
$hxClasses["n4.NBasic"] = n4_NBasic;
n4_NBasic.__name__ = true;
n4_NBasic.prototype = {
	exists: null
	,n4Type: null
	,update: function(dt) {
...
var n4_NClock = function() {
	this.reset();
};
$hxClasses["n4.NClock"] = n4_NClock;
n4_NClock.__name__ = true;
n4_NClock.prototype = {
	dt: null
	,last: null
	,getTime: function() {
	...
	,reset: function() {
		this.last = kha_Scheduler.realTime();
		this.dt = 0;
	}
	,__class__: n4_NClock
};
...
var n4_NEntity = function(X,Y,Width,Height) {
	if(Height == null) {
		Height = 0;
	}
	if(Width == null) {
...
$hxClasses["n4.NEntity"] = n4_NEntity;
n4_NEntity.__name__ = true;
n4_NEntity.separate = function(Object1,Object2) {
	var separatedX = n4_NEntity.separateX(Object1,Object2);
	var separatedY = n4_NEntity.separateY(Object1,Object2);
	if(!separatedX) {
		return separatedY;
	} else {
		return true;
...
n4_NEntity.updateTouchingFlags = function(Object1,Object2) {
	var touchingX = n4_NEntity.updateTouchingFlagsX(Object1,Object2);
	var touchingY = n4_NEntity.updateTouchingFlagsY(Object1,Object2);
	if(!touchingX) {
		return touchingY;
	} else {
		return true;
...
n4_NEntity.computeOverlapX = function(Object1,Object2,checkMaxOverlap) {
	...
	if(obj1delta != obj2delta) {
		...
		var _this = n4_NEntity._firstSeparateNRect;
		var Width = Object1.get_width() + obj1deltaAbs;
		var Height = Object1.get_height();
		_this.x = Object1.x - (obj1delta > 0 ? obj1delta : 0);
		_this.y = Object1.last.y;
		_this.width = Width;
		_this.height = Height;
		var _this1 = n4_NEntity._secondSeparateNRect;
		var Width1 = Object2.get_width() + obj2deltaAbs;
		var Height1 = Object2.get_height();
		_this1.x = Object2.x - (obj2delta > 0 ? obj2delta : 0);
		_this1.y = Object2.last.y;
		_this1.width = Width1;
		...
		if(_this.x + _this.width > _this1.x && _this.x < _this1.x + _this1.width && _this.y + _this.height > _this1.y && _this.y < _this1.y + _this1.height) {
			var maxOverlap = checkMaxOverlap ? obj1deltaAbs + obj2deltaAbs + n4_NEntity.SEPARATE_BIAS : 0;
			if(obj1delta > obj2delta) {
...
n4_NEntity.separateX = function(Object1,Object2) {
	var obj1immovable = Object1.immovable;
	var obj2immovable = Object2.immovable;
	if(obj1immovable && obj2immovable) {
		return false;
	}
	var overlap = n4_NEntity.computeOverlapX(Object1,Object2);
	if(overlap != 0) {
...
n4_NEntity.updateTouchingFlagsX = function(Object1,Object2) {
	return n4_NEntity.computeOverlapX(Object1,Object2,false) != 0;
};
n4_NEntity.computeOverlapY = function(Object1,Object2,checkMaxOverlap) {
	if(checkMaxOverlap == null) {
		checkMaxOverlap = true;
	}
	var overlap = 0;
	...
	if(obj1delta != obj2delta) {
		...
		_this.x = Object1.x;
		_this.y = Object1.y - (obj1delta > 0 ? obj1delta : 0);
		_this.width = Width;
		_this.height = Height;
		var _this1 = n4_NEntity._secondSeparateNRect;
		...
		_this1.x = Object2.x;
		_this1.y = Object2.y - (obj2delta > 0 ? obj2delta : 0);
		_this1.width = Width1;
		_this1.height = Height1;
		if(_this.x + _this.width > _this1.x && _this.x < _this1.x + _this1.width && _this.y + _this.height > _this1.y && _this.y < _this1.y + _this1.height) {
			var maxOverlap = checkMaxOverlap ? obj1deltaAbs + obj2deltaAbs + n4_NEntity.SEPARATE_BIAS : 0;
...
n4_NEntity.separateY = function(Object1,Object2) {
	var obj1immovable = Object1.immovable;
	var obj2immovable = Object2.immovable;
	if(obj1immovable && obj2immovable) {
		return false;
	}
	var overlap = n4_NEntity.computeOverlapY(Object1,Object2);
	if(overlap != 0) {
		var obj1delta = Object1.y - Object1.last.y;
		var obj2delta = Object2.y - Object2.last.y;
...
n4_NEntity.updateTouchingFlagsY = function(Object1,Object2) {
	return n4_NEntity.computeOverlapY(Object1,Object2,false) != 0;
};
...
n4_NEntity.prototype = $extend(n4_NBasic.prototype,{
	...
	,init: function() {
		...
		this.last = new n4_math_NPoint(this.x,this.y);
		...
		this.scrollFactor = new n4_math_NPoint(1,1);
	}
	,update: function(dt) {
	...
	,updateMotion: function(dt) {
		var velocityDelta = 0.5 * (n4_math_NVelocityCalc.computeVelocity(this.angularVelocity,this.angularAcceleration,this.angularDrag,this.maxAngular,dt) - this.angularVelocity);
	...
	,screenCenter: function(axes) {
		if(axes == null) {
			axes = n4_util_NAxes.XY;
		}
		if(axes != n4_util_NAxes.Y) {
			this.set_x(n4_NGame.width / 2 - this.get_width() / 2);
		}
		if(axes != n4_util_NAxes.X) {
			this.set_y(n4_NGame.height / 2 - this.get_height() / 2);
		}
		return this;
	}
	...
	,get_momentum: function() {
		return this.velocity.toVector().scale(this.mass);
	}
	...
	,get_center: function() {
		return new n4_math_NPoint(this.x + this.get_width() / 2,this.y + this.get_height() / 2);
	}
	,get_damage: function() {
		return this.health / this.maxHealth;
	}
	,set_damage: function(f) {
		this.health = f * this.maxHealth;
...
$hxClasses["n4.group.NTypedGroup"] = n4_group_NTypedGroup;
n4_group_NTypedGroup.__name__ = true;
n4_group_NTypedGroup.resolveGroup = function(ObjectOrGroup) {
	var group = null;
	if(ObjectOrGroup != null) {
		if(ObjectOrGroup.n4Type == 2) {
			group = ObjectOrGroup;
		}
	}
	return group;
};
n4_group_NTypedGroup.__super__ = n4_NBasic;
n4_group_NTypedGroup.prototype = $extend(n4_NBasic.prototype,{
	members: null
	,memberCount: null
	,maxSize: null
	,freePosition: null
	,getFirstAvailable: function() {
		var i = this.freePosition;
		while(i < this.members.length + this.freePosition) {
			var h = i % this.members.length;
			if(this.members[h] == null || !this.members[h].exists) {
	...
	,add: function(Object) {
		if(this.members.length < this.maxSize) {
			...
			var index = this.getFirstAvailable();
			if(index < 0) {
				index = this.freePosition;
				++this.freePosition;
				this.freePosition %= this.members.length;
				--this.memberCount;
			}
	...
	,destroy: function() {
		n4_NBasic.prototype.destroy.call(this);
	...
	,__class__: n4_group_NTypedGroup
});
var n4_NState = function() {
	this.bgColor = -16777216;
	n4_group_NTypedGroup.call(this);
};
$hxClasses["n4.NState"] = n4_NState;
n4_NState.__name__ = true;
n4_NState.__super__ = n4_group_NTypedGroup;
n4_NState.prototype = $extend(n4_group_NTypedGroup.prototype,{
	bgColor: null
	,create: function() {
	}
	,render: function(f) {
		n4_group_NTypedGroup.prototype.render.call(this,f);
	}
...
var n4_NGame = function() { };
$hxClasses["n4.NGame"] = n4_NGame;
n4_NGame.__name__ = true;
n4_NGame.init = function(Title,Width,Height,InitialState,Framerate) {
	if(Framerate == null) {
		Framerate = 60;
	}
	if(Height == null) {
	...
	n4_NGame.width = Width;
	n4_NGame.height = Height;
	n4_NGame.targetFramerate = Framerate;
	n4_NGame._initialState = InitialState == null ? n4_NState : InitialState;
	kha_System.init({ title : Title, width : Width, height : Height, samplesPerPixel : 16},function() {
		n4_NGame.onInitialized();
	});
};
n4_NGame.switchState = function(state) {
	n4_NGame.currentState = state;
	n4_NGame.currentState.create();
};
n4_NGame.ge_update = function() {
	++n4_NGame.updateFrameCount;
	n4_NGame._clock.update();
	var gdt = Math.min(n4_NGame._clock.dt,2 / n4_NGame.targetFramerate);
	n4_NGame.timers.update(gdt);
	n4_NGame.currentState.update(gdt);
};
n4_NGame.ge_render = function(framebuffer) {
	if(n4_NGame.syncDrawUpdate) {
		n4_NGame.ge_update();
	}
	++n4_NGame.drawFrameCount;
	if(n4_NGame.useDoubleBuffering) {
		n4_NGame._backbuffer.get_g2().begin(true,n4_NGame.currentState.bgColor);
		n4_NGame.currentState.render(n4_NGame._backbuffer);
		n4_NGame._backbuffer.get_g2().end();
		framebuffer.get_g2().begin();
		kha_Scaler.scale(n4_NGame._backbuffer,framebuffer,kha_System.get_screenRotation());
		framebuffer.get_g2().end();
	} else {
		framebuffer.get_g2().begin(true,n4_NGame.currentState.bgColor);
		n4_NGame.currentState.render(framebuffer);
		framebuffer.get_g2().end();
	}
};
n4_NGame.onInitialized = function() {
	n4_NGame._clock = new n4_NClock();
	n4_NGame.initVars();
	n4_NGame.timers = new n4_events_NTimerManager();
	n4_NGame.keys = new n4_input_keyboard_NKeyboard();
	n4_NGame._backbuffer = kha_Image.createRenderTarget(n4_NGame.width,n4_NGame.height);
	n4_NGame.currentState = new n4_preload_N4AssetPreloader();
	n4_NGame.switchState(n4_NGame.currentState);
	kha_Assets.loadEverything(n4_NGame.onAssetsLoaded);
	kha_System.notifyOnRender(n4_NGame.ge_render);
	if(!n4_NGame.syncDrawUpdate) {
		kha_Scheduler.addTimeTask(n4_NGame.ge_update,0,1 / n4_NGame.targetFramerate);
	}
};
n4_NGame.onAssetsLoaded = function() {
	n4_NGame.currentState = Type.createInstance(n4_NGame._initialState,[]);
	n4_NGame.switchState(n4_NGame.currentState);
};
n4_NGame.initVars = function() {
	var _this = n4_NGame.worldBounds;
	_this.x = -10;
	_this.y = -10;
	_this.width = n4_NGame.width + 20;
	_this.height = n4_NGame.height + 20;
	n4_NGame.drawFrameCount = 0;
	n4_NGame.updateFrameCount = 0;
};
n4_NGame.get_assetsLoaded = function() {
	return !(kha_Assets.progress < 1);
};
n4_NGame.collide = function(ObjectOrGroup1,ObjectOrGroup2,NotifyCallback) {
	return n4_NGame.overlap(ObjectOrGroup1,ObjectOrGroup2,NotifyCallback,n4_NEntity.separate);
};
n4_NGame.overlap = function(ObjectOrGroup1,ObjectOrGroup2,NotifyCallback,ProcessCallback) {
	if(ObjectOrGroup1 == null) {
		ObjectOrGroup1 = n4_NGame.currentState;
	}
	if(ObjectOrGroup2 == ObjectOrGroup1) {
		ObjectOrGroup2 = null;
	}
	n4_system_NQuadTree.divisions = n4_NGame.worldDivisions;
	var quadTree = n4_system_NQuadTree.recycle(n4_NGame.worldBounds.x,n4_NGame.worldBounds.y,n4_NGame.worldBounds.width,n4_NGame.worldBounds.height);
...
var n4_entities_NSprite = function(X,Y,Graphic) {
	...
	this.color = -1;
	n4_NEntity.call(this,X,Y);
	this.set_graphic(Graphic);
};
$hxClasses["n4.entities.NSprite"] = n4_entities_NSprite;
n4_entities_NSprite.__name__ = true;
n4_entities_NSprite.__super__ = n4_NEntity;
n4_entities_NSprite.prototype = $extend(n4_NEntity.prototype,{
	graphic: null
	,color: null
	,render: function(f) {
		var ctx = f.get_g2();
		ctx.set_color(this.color);
		ctx.pushRotation(this.angle,this.x + this.get_width() / 2,this.y + this.get_height() / 2);
		ctx.drawImage(this.graphic,this.x,this.y);
		ctx.popTransformation();
		n4_NEntity.prototype.render.call(this,f);
	}
	,makeGraphic: function(Width,Height,GraphicColor) {
		var g = n4_pooling_NGraphicPool.getM(Width,Height,GraphicColor);
		this.set_width(Width);
		this.set_height(Height);
		if(g == null) {
			...
			this.graphic.get_g2().fillRect(0,0,Width,Height);
			this.graphic.get_g2().end();
			n4_pooling_NGraphicPool.putM(Width,Height,GraphicColor,this.graphic);
		} else {
			this.set_graphic(g);
		}
		return this;
	}
	,renderGraphic: function(Width,Height,render,Key) {
		var g = n4_pooling_NGraphicPool.getR(Width,Height,Key);
		this.set_width(Width);
		this.set_height(Height);
		if(g == null) {
			...
			if(Key != null) {
				n4_pooling_NGraphicPool.putR(Width,Height,Key,this.graphic);
			}
		} else {
			this.set_graphic(g);
		}
	...
	,__class__: n4_entities_NSprite
});
var n4_effects_particles_NParticle = function(X,Y,PColor,Life) {
	if(Life == null) {
		Life = 0;
	}
	if(Y == null) {
...
$hxClasses["n4.effects.particles.NParticle"] = n4_effects_particles_NParticle;
n4_effects_particles_NParticle.__name__ = true;
n4_effects_particles_NParticle.__super__ = n4_entities_NSprite;
n4_effects_particles_NParticle.prototype = $extend(n4_entities_NSprite.prototype,{
	life: null
	,age: null
	,particleColor: null
	,update: function(dt) {
		...
		if(this.age >= this.life) {
			...
			this.color = kha__$Color_Color_$Impl_$.fromFloats(((this.particleColor & 16711680) >>> 16) * 0.00392156862745098,((this.particleColor & 65280) >>> 8) * 0.00392156862745098,(this.particleColor & 255) * 0.00392156862745098,1 - this.age / this.life);
		}
...
$hxClasses["n4.events.NTimer"] = n4_events_NTimer;
n4_events_NTimer.__name__ = true;
n4_events_NTimer.prototype = {
	triggerTime: null
	,_callback: null
	,execute: function() {
		this._callback();
	}
	,__class__: n4_events_NTimer
};
var n4_events_NTimerManager = function() {
	this.totalElapsed = 0;
	this.timers = [];
};
$hxClasses["n4.events.NTimerManager"] = n4_events_NTimerManager;
n4_events_NTimerManager.__name__ = true;
n4_events_NTimerManager.prototype = {
	timers: null
	,totalElapsed: null
	,update: function(dt) {
		...
		while(i < this.timers.length) {
			var t = this.timers[i];
			if(this.totalElapsed >= t.triggerTime) {
				t.execute();
	...
	,setTimer: function(delay,callback) {
		this.timers.push(new n4_events_NTimer(this.totalElapsed + delay / 1000,callback));
	}
	,__class__: n4_events_NTimerManager
};
var n4_input_NPressEventState = function() {
	this.down = false;
};
$hxClasses["n4.input.NPressEventState"] = n4_input_NPressEventState;
n4_input_NPressEventState.__name__ = true;
n4_input_NPressEventState.prototype = {
	justPressed: null
	,pressed: null
	,down: null
	,pressFrame: null
	,press: function() {
		this.pressFrame = n4_NGame.updateFrameCount;
		this.down = true;
	}
	,release: function() {
		this.down = false;
	...
	,__class__: n4_input_NPressEventState
};
var n4_input_keyboard_NKeyState = function() {
	n4_input_NPressEventState.call(this);
};
$hxClasses["n4.input.keyboard.NKeyState"] = n4_input_keyboard_NKeyState;
n4_input_keyboard_NKeyState.__name__ = true;
n4_input_keyboard_NKeyState.__super__ = n4_input_NPressEventState;
n4_input_keyboard_NKeyState.prototype = $extend(n4_input_NPressEventState.prototype,{
	__class__: n4_input_keyboard_NKeyState
});
var n4_input_keyboard_NKeyboard = function() {
	this.list = [];
	this.state = new haxe_ds_StringMap();
	kha_input_Keyboard.get().notify($bind(this,this.onKeyDown),$bind(this,this.onKeyUp));
};
$hxClasses["n4.input.keyboard.NKeyboard"] = n4_input_keyboard_NKeyboard;
n4_input_keyboard_NKeyboard.__name__ = true;
n4_input_keyboard_NKeyboard.prototype = {
	state: null
	,list: null
	,fillPosition: function(c) {
		var v = new n4_input_keyboard_NKeyState();
		var _this = this.state;
		if(__map_reserved[c] != null) {
			_this.setReserved(c,v);
		} else {
			_this.h[c] = v;
		}
	}
	,onKeyDown: function(k,c) {
		...
		(__map_reserved[c] != null ? _this3.getReserved(c) : _this3.h[c]).press();
	}
	,onKeyUp: function(k,c) {
		...
		var _this3 = this.state;
		HxOverrides.remove(this.list,__map_reserved[c] != null ? _this3.getReserved(c) : _this3.h[c]);
	}
	,pressed: function(keys) {
		...
		while(_g < keys.length) {
			...
			var _this2 = this.state;
			if((__map_reserved[key] != null ? _this2.getReserved(key) : _this2.h[key]).get_pressed()) {
				return true;
			}
		}
		return false;
	}
	,justPressed: function(keys) {
		var _g = 0;
		while(_g < keys.length) {
			var key = keys[_g];
			++_g;
			...
			var _this2 = this.state;
			if((__map_reserved[key] != null ? _this2.getReserved(key) : _this2.h[key]).get_justPressed()) {
				return true;
			}
		}
		return false;
...
var n4_input_touch_NTouchState = function() {
	n4_input_NPressEventState.call(this);
};
$hxClasses["n4.input.touch.NTouchState"] = n4_input_touch_NTouchState;
n4_input_touch_NTouchState.__name__ = true;
n4_input_touch_NTouchState.__super__ = n4_input_NPressEventState;
n4_input_touch_NTouchState.prototype = $extend(n4_input_NPressEventState.prototype,{
	__class__: n4_input_touch_NTouchState
});
var n4_input_touch_NTouchSurface = function() {
	this.state = new haxe_ds_StringMap();
	kha_input_Surface.get().notify($bind(this,this.onTouchStart),$bind(this,this.onTouchEnd),$bind(this,this.onTouchMove));
};
$hxClasses["n4.input.touch.NTouchSurface"] = n4_input_touch_NTouchSurface;
n4_input_touch_NTouchSurface.__name__ = true;
n4_input_touch_NTouchSurface.prototype = {
	state: null
	,list: null
	...
	,__class__: n4_input_touch_NTouchSurface
};
...
n4_math_NVelocityCalc.computeVelocity = function(Velocity,Acceleration,Drag,Max,Elapsed) {
	if(Acceleration != 0) {
...
var n4_pooling_NGraphicPool = function() { };
$hxClasses["n4.pooling.NGraphicPool"] = n4_pooling_NGraphicPool;
n4_pooling_NGraphicPool.__name__ = true;
n4_pooling_NGraphicPool.hashM = function(Width,Height,ItemColor) {
	return Width + Height + ItemColor + "M";
};
n4_pooling_NGraphicPool.putM = function(Width,Height,ItemColor,Graphic) {
	var h = Width + Height + ItemColor + "M";
	var _this = n4_pooling_NGraphicPool.items;
	if(__map_reserved[h] != null) {
		_this.setReserved(h,Graphic);
	} else {
		_this.h[h] = Graphic;
	}
};
n4_pooling_NGraphicPool.getM = function(Width,Height,ItemColor) {
	var h = Width + Height + ItemColor + "M";
	var _this = n4_pooling_NGraphicPool.items;
	if(__map_reserved[h] != null) {
		return _this.getReserved(h);
	} else {
		return _this.h[h];
	}
};
n4_pooling_NGraphicPool.hashR = function(Width,Height,Key) {
	return Width + Height + Key + "R";
};
n4_pooling_NGraphicPool.putR = function(Width,Height,Key,Graphic) {
	var h = Width + Height + Key + "R";
	var _this = n4_pooling_NGraphicPool.items;
	if(__map_reserved[h] != null) {
		_this.setReserved(h,Graphic);
	} else {
...
n4_pooling_NGraphicPool.getR = function(Width,Height,Key) {
	var h = Width + Height + Key + "R";
	var _this = n4_pooling_NGraphicPool.items;
	if(__map_reserved[h] != null) {
		return _this.getReserved(h);
...
var n4_preload_N4AssetPreloader = function() {
	n4_NState.call(this);
};
$hxClasses["n4.preload.N4AssetPreloader"] = n4_preload_N4AssetPreloader;
n4_preload_N4AssetPreloader.__name__ = true;
n4_preload_N4AssetPreloader.__super__ = n4_NState;
n4_preload_N4AssetPreloader.prototype = $extend(n4_NState.prototype,{
	create: function() {
	}
	,__class__: n4_preload_N4AssetPreloader
});
var n4_util_INDestroyable = function() { };
$hxClasses["n4.util.INDestroyable"] = n4_util_INDestroyable;
n4_util_INDestroyable.__name__ = true;
n4_util_INDestroyable.prototype = {
	destroy: null
	,__class__: n4_util_INDestroyable
};
var n4_system_NLinkedList = function() {
	this.exists = true;
};
$hxClasses["n4.system.NLinkedList"] = n4_system_NLinkedList;
n4_system_NLinkedList.__name__ = true;
n4_system_NLinkedList.__interfaces__ = [n4_util_INDestroyable];
n4_system_NLinkedList.recycle = function() {
	if(n4_system_NLinkedList._cachedListsHead != null) {
		var cachedList = n4_system_NLinkedList._cachedListsHead;
		n4_system_NLinkedList._cachedListsHead = n4_system_NLinkedList._cachedListsHead.next;
		n4_system_NLinkedList._NUM_CACHED_N_LIST--;
		cachedList.exists = true;
		cachedList.next = null;
		return cachedList;
	} else {
		return new n4_system_NLinkedList();
	}
};
n4_system_NLinkedList.clearCache = function() {
	while(n4_system_NLinkedList._cachedListsHead != null) {
		var node = n4_system_NLinkedList._cachedListsHead;
		n4_system_NLinkedList._cachedListsHead = n4_system_NLinkedList._cachedListsHead.next;
		node.object = null;
		node.next = null;
	}
	n4_system_NLinkedList._NUM_CACHED_N_LIST = 0;
};
n4_system_NLinkedList.prototype = {
	object: null
	,next: null
	,exists: null
	,destroy: function() {
		...
		this.exists = false;
		this.next = n4_system_NLinkedList._cachedListsHead;
		n4_system_NLinkedList._cachedListsHead = this;
		n4_system_NLinkedList._NUM_CACHED_N_LIST++;
	}
	,__class__: n4_system_NLinkedList
};
var n4_system_NQuadTree = function(X,Y,Width,Height,Parent) {
	n4_math_NRect.call(this);
	this.x = X;
	this.y = Y;
	this.width = Width;
	this.height = Height;
...
$hxClasses["n4.system.NQuadTree"] = n4_system_NQuadTree;
n4_system_NQuadTree.__name__ = true;
n4_system_NQuadTree.__interfaces__ = [n4_util_INDestroyable];
n4_system_NQuadTree.recycle = function(X,Y,Width,Height,Parent) {
	if(n4_system_NQuadTree._cachedTreesHead != null) {
		var cachedTree = n4_system_NQuadTree._cachedTreesHead;
		n4_system_NQuadTree._cachedTreesHead = n4_system_NQuadTree._cachedTreesHead.next;
		n4_system_NQuadTree._NUM_CACHED_QUAD_TREES--;
		cachedTree.reset(X,Y,Width,Height,Parent);
		return cachedTree;
	} else {
		return new n4_system_NQuadTree(X,Y,Width,Height,Parent);
	}
};
n4_system_NQuadTree.clearCache = function() {
	while(n4_system_NQuadTree._cachedTreesHead != null) {
		var node = n4_system_NQuadTree._cachedTreesHead;
		n4_system_NQuadTree._cachedTreesHead = n4_system_NQuadTree._cachedTreesHead.next;
		node.next = null;
	}
	n4_system_NQuadTree._NUM_CACHED_QUAD_TREES = 0;
};
n4_system_NQuadTree.__super__ = n4_math_NRect;
n4_system_NQuadTree.prototype = $extend(n4_math_NRect.prototype,{
	exists: null
	,_canSubdivide: null
	,_headA: null
	,_tailA: null
	...
	,reset: function(X,Y,Width,Height,Parent) {
		...
		this.width = Width;
		this.height = Height;
		this._headA = this._tailA = n4_system_NLinkedList.recycle();
		this._headB = this._tailB = n4_system_NLinkedList.recycle();
		if(Parent != null) {
			var iterator;
			var ot;
			if(Parent._headA.object != null) {
				...
				while(iterator != null) {
					if(this._tailA.object != null) {
						ot = this._tailA;
						this._tailA = n4_system_NLinkedList.recycle();
						ot.next = this._tailA;
					}
			...
			if(Parent._headB.object != null) {
				...
				while(iterator != null) {
					if(this._tailB.object != null) {
						ot = this._tailB;
						this._tailB = n4_system_NLinkedList.recycle();
						ot.next = this._tailB;
					}
			...
			n4_system_NQuadTree._min = Math.floor((this.width + this.height) / (2 * n4_system_NQuadTree.divisions));
		}
		this._canSubdivide = this.width > n4_system_NQuadTree._min || this.height > n4_system_NQuadTree._min;
	...
	,destroy: function() {
		this._headA = n4_util_NDestroyUtil.destroy(this._headA);
		this._headB = n4_util_NDestroyUtil.destroy(this._headB);
		this._tailA = n4_util_NDestroyUtil.destroy(this._tailA);
		this._tailB = n4_util_NDestroyUtil.destroy(this._tailB);
		this._northWestTree = n4_util_NDestroyUtil.destroy(this._northWestTree);
		this._northEastTree = n4_util_NDestroyUtil.destroy(this._northEastTree);
		this._southWestTree = n4_util_NDestroyUtil.destroy(this._southWestTree);
		this._southEastTree = n4_util_NDestroyUtil.destroy(this._southEastTree);
		n4_system_NQuadTree._object = null;
		n4_system_NQuadTree._processingCallback = null;
		n4_system_NQuadTree._notifyCallback = null;
		this.exists = false;
		this.next = n4_system_NQuadTree._cachedTreesHead;
		n4_system_NQuadTree._cachedTreesHead = this;
		n4_system_NQuadTree._NUM_CACHED_QUAD_TREES++;
		n4_math_NRect.prototype.destroy.call(this);
	}
	,load: function(ObjectOrGroup1,ObjectOrGroup2,NotifyCallback,ProcessCallback) {
		...
		if(ObjectOrGroup2 != null) {
			...
			n4_system_NQuadTree._useBothLists = true;
		} else {
			n4_system_NQuadTree._useBothLists = false;
		}
		n4_system_NQuadTree._notifyCallback = NotifyCallback;
		n4_system_NQuadTree._processingCallback = ProcessCallback;
	}
	,add: function(ObjectOrGroup,list) {
		n4_system_NQuadTree._list = list;
		var group = n4_group_NTypedGroup.resolveGroup(ObjectOrGroup);
		if(group != null) {
			var i = 0;
			var basic;
			var members = group.members;
			var l = group.members.length;
			while(i < l) {
				basic = members[i++];
				if(basic != null && basic.exists) {
					group = n4_group_NTypedGroup.resolveGroup(basic);
					if(group != null) {
						this.add(group,list);
					} else {
						n4_system_NQuadTree._object = basic;
						if(n4_system_NQuadTree._object.exists && n4_system_NQuadTree._object.allowCollisions != 0) {
							n4_system_NQuadTree._objectLeftEdge = n4_system_NQuadTree._object.x;
							n4_system_NQuadTree._objectTopEdge = n4_system_NQuadTree._object.y;
							n4_system_NQuadTree._objectRightEdge = n4_system_NQuadTree._object.x + n4_system_NQuadTree._object.get_width();
							n4_system_NQuadTree._objectBottomEdge = n4_system_NQuadTree._object.y + n4_system_NQuadTree._object.get_height();
							this.addObject();
						}
					}
				}
			...
			n4_system_NQuadTree._object = ObjectOrGroup;
			if(n4_system_NQuadTree._object.exists && n4_system_NQuadTree._object.allowCollisions != 0) {
				n4_system_NQuadTree._objectLeftEdge = n4_system_NQuadTree._object.x;
				n4_system_NQuadTree._objectTopEdge = n4_system_NQuadTree._object.y;
				n4_system_NQuadTree._objectRightEdge = n4_system_NQuadTree._object.x + n4_system_NQuadTree._object.get_width();
	...
	,addObject: function() {
		if(!this._canSubdivide || this._leftEdge >= n4_system_NQuadTree._objectLeftEdge && this._rightEdge <= n4_system_NQuadTree._objectRightEdge && this._topEdge >= n4_system_NQuadTree._objectTopEdge && this._bottomEdge <= n4_system_NQuadTree._objectBottomEdge) {
			this.addToList();
			return;
		}
		if(n4_system_NQuadTree._objectLeftEdge > this._leftEdge && n4_system_NQuadTree._objectRightEdge < this._midpointX) {
			if(n4_system_NQuadTree._objectTopEdge > this._topEdge && n4_system_NQuadTree._objectBottomEdge < this._midpointY) {
				if(this._northWestTree == null) {
					this._northWestTree = n4_system_NQuadTree.recycle(this._leftEdge,this._topEdge,this._halfWidth,this._halfHeight,this);
				}
				this._northWestTree.addObject();
				return;
			}
			if(n4_system_NQuadTree._objectTopEdge > this._midpointY && n4_system_NQuadTree._objectBottomEdge < this._bottomEdge) {
				if(this._southWestTree == null) {
					this._southWestTree = n4_system_NQuadTree.recycle(this._leftEdge,this._midpointY,this._halfWidth,this._halfHeight,this);
				}
				this._southWestTree.addObject();
				return;
			}
		}
		if(n4_system_NQuadTree._objectLeftEdge > this._midpointX && n4_system_NQuadTree._objectRightEdge < this._rightEdge) {
			if(n4_system_NQuadTree._objectTopEdge > this._topEdge && n4_system_NQuadTree._objectBottomEdge < this._midpointY) {
				if(this._northEastTree == null) {
					this._northEastTree = n4_system_NQuadTree.recycle(this._midpointX,this._topEdge,this._halfWidth,this._halfHeight,this);
				}
			...
			if(n4_system_NQuadTree._objectTopEdge > this._midpointY && n4_system_NQuadTree._objectBottomEdge < this._bottomEdge) {
				if(this._southEastTree == null) {
					this._southEastTree = n4_system_NQuadTree.recycle(this._midpointX,this._midpointY,this._halfWidth,this._halfHeight,this);
				}
				this._southEastTree.addObject();
				return;
			}
		}
		if(n4_system_NQuadTree._objectRightEdge > this._leftEdge && n4_system_NQuadTree._objectLeftEdge < this._midpointX && n4_system_NQuadTree._objectBottomEdge > this._topEdge && n4_system_NQuadTree._objectTopEdge < this._midpointY) {
			if(this._northWestTree == null) {
				this._northWestTree = n4_system_NQuadTree.recycle(this._leftEdge,this._topEdge,this._halfWidth,this._halfHeight,this);
			}
			this._northWestTree.addObject();
		}
		if(n4_system_NQuadTree._objectRightEdge > this._midpointX && n4_system_NQuadTree._objectLeftEdge < this._rightEdge && n4_system_NQuadTree._objectBottomEdge > this._topEdge && n4_system_NQuadTree._objectTopEdge < this._midpointY) {
			if(this._northEastTree == null) {
				this._northEastTree = n4_system_NQuadTree.recycle(this._midpointX,this._topEdge,this._halfWidth,this._halfHeight,this);
			}
			this._northEastTree.addObject();
		}
		if(n4_system_NQuadTree._objectRightEdge > this._midpointX && n4_system_NQuadTree._objectLeftEdge < this._rightEdge && n4_system_NQuadTree._objectBottomEdge > this._midpointY && n4_system_NQuadTree._objectTopEdge < this._bottomEdge) {
			if(this._southEastTree == null) {
				this._southEastTree = n4_system_NQuadTree.recycle(this._midpointX,this._midpointY,this._halfWidth,this._halfHeight,this);
			}
			this._southEastTree.addObject();
		}
		if(n4_system_NQuadTree._objectRightEdge > this._leftEdge && n4_system_NQuadTree._objectLeftEdge < this._midpointX && n4_system_NQuadTree._objectBottomEdge > this._midpointY && n4_system_NQuadTree._objectTopEdge < this._bottomEdge) {
			if(this._southWestTree == null) {
				this._southWestTree = n4_system_NQuadTree.recycle(this._leftEdge,this._midpointY,this._halfWidth,this._halfHeight,this);
			}
			this._southWestTree.addObject();
	...
	,addToList: function() {
		var ot;
		if(n4_system_NQuadTree._list == 0) {
			if(this._tailA.object != null) {
				ot = this._tailA;
				this._tailA = n4_system_NLinkedList.recycle();
				ot.next = this._tailA;
			}
			this._tailA.object = n4_system_NQuadTree._object;
		} else {
			if(this._tailB.object != null) {
				ot = this._tailB;
				this._tailB = n4_system_NLinkedList.recycle();
			...
			this._tailB.object = n4_system_NQuadTree._object;
		}
	...
	,execute: function() {
		...
		if(this._headA.object != null) {
			...
			while(iterator != null) {
				n4_system_NQuadTree._object = iterator.object;
				if(n4_system_NQuadTree._useBothLists) {
					n4_system_NQuadTree._iterator = this._headB;
				} else {
					n4_system_NQuadTree._iterator = iterator.next;
				}
				if(n4_system_NQuadTree._object != null && n4_system_NQuadTree._object.exists && n4_system_NQuadTree._object.allowCollisions > 0 && n4_system_NQuadTree._iterator != null && n4_system_NQuadTree._iterator.object != null && this.overlapNode()) {
	...
	,overlapNode: function() {
		n4_system_NQuadTree._objectHullX = n4_system_NQuadTree._object.x < n4_system_NQuadTree._object.last.x ? n4_system_NQuadTree._object.x : n4_system_NQuadTree._object.last.x;
		n4_system_NQuadTree._objectHullY = n4_system_NQuadTree._object.y < n4_system_NQuadTree._object.last.y ? n4_system_NQuadTree._object.y : n4_system_NQuadTree._object.last.y;
		n4_system_NQuadTree._objectHullWidth = n4_system_NQuadTree._object.x - n4_system_NQuadTree._object.last.x;
		n4_system_NQuadTree._objectHullWidth = n4_system_NQuadTree._object.get_width() + (n4_system_NQuadTree._objectHullWidth > 0 ? n4_system_NQuadTree._objectHullWidth : -n4_system_NQuadTree._objectHullWidth);
		n4_system_NQuadTree._objectHullHeight = n4_system_NQuadTree._object.y - n4_system_NQuadTree._object.last.y;
		n4_system_NQuadTree._objectHullHeight = n4_system_NQuadTree._object.get_height() + (n4_system_NQuadTree._objectHullHeight > 0 ? n4_system_NQuadTree._objectHullHeight : -n4_system_NQuadTree._objectHullHeight);
		var overlapProcessed = false;
		var checkObject;
		while(n4_system_NQuadTree._iterator != null) {
			checkObject = n4_system_NQuadTree._iterator.object;
			if(n4_system_NQuadTree._object == checkObject || !checkObject.exists || checkObject.allowCollisions <= 0) {
				n4_system_NQuadTree._iterator = n4_system_NQuadTree._iterator.next;
				continue;
			}
			n4_system_NQuadTree._checkObjectHullX = checkObject.x < checkObject.last.x ? checkObject.x : checkObject.last.x;
			n4_system_NQuadTree._checkObjectHullY = checkObject.y < checkObject.last.y ? checkObject.y : checkObject.last.y;
			n4_system_NQuadTree._checkObjectHullWidth = checkObject.x - checkObject.last.x;
			n4_system_NQuadTree._checkObjectHullWidth = checkObject.get_width() + (n4_system_NQuadTree._checkObjectHullWidth > 0 ? n4_system_NQuadTree._checkObjectHullWidth : -n4_system_NQuadTree._checkObjectHullWidth);
			n4_system_NQuadTree._checkObjectHullHeight = checkObject.y - checkObject.last.y;
			n4_system_NQuadTree._checkObjectHullHeight = checkObject.get_height() + (n4_system_NQuadTree._checkObjectHullHeight > 0 ? n4_system_NQuadTree._checkObjectHullHeight : -n4_system_NQuadTree._checkObjectHullHeight);
			if(n4_system_NQuadTree._objectHullX + n4_system_NQuadTree._objectHullWidth > n4_system_NQuadTree._checkObjectHullX && n4_system_NQuadTree._objectHullX < n4_system_NQuadTree._checkObjectHullX + n4_system_NQuadTree._checkObjectHullWidth && n4_system_NQuadTree._objectHullY + n4_system_NQuadTree._objectHullHeight > n4_system_NQuadTree._checkObjectHullY && n4_system_NQuadTree._objectHullY < n4_system_NQuadTree._checkObjectHullY + n4_system_NQuadTree._checkObjectHullHeight) {
				if(n4_system_NQuadTree._processingCallback == null || n4_system_NQuadTree._processingCallback(n4_system_NQuadTree._object,checkObject)) {
					overlapProcessed = true;
					if(n4_system_NQuadTree._notifyCallback != null) {
						n4_system_NQuadTree._notifyCallback(n4_system_NQuadTree._object,checkObject);
					}
				}
			}
			if(n4_system_NQuadTree._iterator != null) {
				n4_system_NQuadTree._iterator = n4_system_NQuadTree._iterator.next;
			}
		}
		return overlapProcessed;
	}
	,__class__: n4_system_NQuadTree
});
var n4_util_NAxes = $hxClasses["n4.util.NAxes"] = { __ename__ : true, __constructs__ : ["X","Y","XY"] };
n4_util_NAxes.X = ["X",0];
n4_util_NAxes.X.toString = $estr;
n4_util_NAxes.X.__enum__ = n4_util_NAxes;
n4_util_NAxes.Y = ["Y",1];
n4_util_NAxes.Y.toString = $estr;
n4_util_NAxes.Y.__enum__ = n4_util_NAxes;
n4_util_NAxes.XY = ["XY",2];
n4_util_NAxes.XY.toString = $estr;
n4_util_NAxes.XY.__enum__ = n4_util_NAxes;
var n4_util_NColorUtil = function() { };
$hxClasses["n4.util.NColorUtil"] = n4_util_NColorUtil;
n4_util_NColorUtil.__name__ = true;
n4_util_NColorUtil.randCol = function(R,G,B,Variation) {
	if(Variation == null) {
		Variation = 0.1;
	}
	var colDiff = Math.random() * Variation * 2 - Variation;
	return kha__$Color_Color_$Impl_$.fromFloats(R + colDiff,G + colDiff,B + colDiff);
};
var n4_util_NDestroyUtil = function() { };
$hxClasses["n4.util.NDestroyUtil"] = n4_util_NDestroyUtil;
n4_util_NDestroyUtil.__name__ = true;
n4_util_NDestroyUtil.destroy = function(object) {
	if(object != null) {
		object.destroy();
	}
	return null;
};
n4_util_NDestroyUtil.destroyArray = function(array) {
	if(array != null) {
		var _g = 0;
		while(_g < array.length) {
			var e = array[_g];
			++_g;
			n4_util_NDestroyUtil.destroy(e);
		}
		array.splice(0,array.length);
	}
	return null;
};
var n4e_ui_NEText = function(X,Y,Text,Size,TextColor,Font) {
	if(Size == null) {
		Size = 16;
	}
	if(Font == null) {
		Font = n4e_ui_NEText.defaultFont;
	}
	if(TextColor == null) {
		TextColor = -1;
	}
	n4_entities_NSprite.call(this,X,Y);
	this.reRenderGraphic(Text,Size,TextColor,Font);
};
$hxClasses["n4e.ui.NEText"] = n4e_ui_NEText;
n4e_ui_NEText.__name__ = true;
n4e_ui_NEText.__super__ = n4_entities_NSprite;
n4e_ui_NEText.prototype = $extend(n4_entities_NSprite.prototype,{
	reRenderGraphic: function(Text,Size,TextColor,Font) {
		if(Size == null) {
			Size = 16;
		}
		this.renderGraphic((Font.width(Size,Text) | 0) + 1,(Font.height(Size) | 0) + 1,function(gpx) {
			var ctx = gpx.get_g2();
			ctx.begin();
			ctx.set_color(TextColor);
			ctx.set_font(Font);
			ctx.set_fontSize(Size);
...
$hxClasses["sprites.Enemy"] = sprites_Enemy;
...
sprites_Penemy.prototype = $extend(sprites_Enemy.prototype,{
	...
	,update: function(dt) {
		this.movement();
		sprites_Enemy.prototype.update.call(this,dt);
		Registry.PS.emitter.emitSquare(this.x + 2.5,this.y + 2.5,16,n4_effects_particles_NParticleEmitter.velocitySpread(this.get_width() * 2),n4_util_NColorUtil.randCol(0.1,0.9,0.4,0.1),0.3);
	}
	,movement: function() {
		var player = Registry.PS.player;
		var posVelocity = new n4_math_NVector(this.x,this.y).subtractPoint(new n4_math_NPoint(player.x,player.y)).toVector().normalize().scale(5 * this.speedInaccuracy + this.speed).rotate(new n4_math_NPoint(0,0),180);
...
var sprites_Player = function(X,Y) {
	...
	this.spedUp = false;
	this.maxVelocityTimer = 5;
	this.speed = 10;
	n4_entities_NSprite.call(this,X,Y);
	this.makeGraphic(20,20,-65536);
	this.drag.set(5,5);
...
sprites_Player.__super__ = n4_entities_NSprite;
sprites_Player.prototype = $extend(n4_entities_NSprite.prototype,{
	speed: null
	,maxVelocityTimer: null
	,spedUp: null
	,update: function(dt) {
		Registry.PS.emitter.emitSquare(this.x + 10,this.y + 10,8,n4_effects_particles_NParticleEmitter.velocitySpread(50),n4_util_NColorUtil.randCol(0.9,0.1,0.1,0.1),0.3);
		this.movement();
		this.maxVelocityTimer += dt;
		n4_entities_NSprite.prototype.update.call(this,dt);
	}
	,movement: function() {
		var up = false;
		...
		var left = false;
		var right = false;
		up = n4_NGame.keys.pressed(["UP","W"]);
		down = n4_NGame.keys.pressed(["DOWN","S"]);
		left = n4_NGame.keys.pressed(["LEFT","A"]);
		right = n4_NGame.keys.pressed(["RIGHT","D"]);
		if(n4_NGame.keys.pressed(["SPACE"," "]) && this.maxVelocityTimer > 5) {
			this.maxVelocity.set(400,400);
			var _g = 0;
			while(_g < 30) {
				++_g;
				Registry.PS.emitter.emitSquare(this.x + 10,this.y + 10,8,n4_effects_particles_NParticleEmitter.velocitySpread(300),n4_util_NColorUtil.randCol(0.9,0.9,0.1,0.3),0.3);
			}
			this.maxVelocityTimer = 0;
			this.spedUp = true;
		}
		if(this.spedUp && this.maxVelocityTimer > 1) {
			this.maxVelocity.set(200,200);
			this.spedUp = false;
		}
		if(up || down || left || right) {
			...
			var movementVel = new n4_math_NPoint(this.speed,0);
			this.velocity.addPoint(movementVel.rotate(new n4_math_NPoint(0,0),mA));
		}
	}
...
$hxClasses["states.GameOverState"] = states_GameOverState;
states_GameOverState.__name__ = true;
states_GameOverState.__super__ = n4_NState;
states_GameOverState.prototype = $extend(n4_NState.prototype,{
	score: null
	,create: function() {
		var titleText = new n4e_ui_NEText(0,n4_NGame.height / 3,"Game Over",60);
		titleText.screenCenter(n4_util_NAxes.X);
		this.add(titleText);
		var titleText1 = new n4e_ui_NEText(0,n4_NGame.height * 2 / 5,"Score: " + this.score,60);
		titleText1.screenCenter(n4_util_NAxes.X);
		this.add(titleText1);
	...
	,__class__: states_GameOverState
});
var states_IntroState = function() {
	n4_NState.call(this);
};
$hxClasses["states.IntroState"] = states_IntroState;
states_IntroState.__name__ = true;
states_IntroState.__super__ = n4_NState;
states_IntroState.prototype = $extend(n4_NState.prototype,{
	create: function() {
		if(n4e_ui_NEText.defaultFont == null) {
			n4e_ui_NEText.defaultFont = kha_Assets.fonts.Raleway;
		}
		this.add(new n4e_ui_NEText(20,20,"Wombat Kombat",35,-1));
		var spinner = new n4_entities_NSprite();
		spinner.angularVelocity = Math.PI * 1.5;
		...
		spinner.screenCenter(n4_util_NAxes.XY);
		this.add(spinner);
		var pbt = new n4e_ui_NEText(0,n4_NGame.height * 0.65,"powered by n4 engine",32);
		pbt.screenCenter(n4_util_NAxes.X);
		this.add(pbt);
		n4_NGame.timers.setTimer(1400,function() {
			n4_NGame.switchState(new states_MenuState());
		});
		n4_NState.prototype.create.call(this);
	}
...
states_MenuState.prototype = $extend(n4_NState.prototype,{
	create: function() {
		var titleText = new n4e_ui_NEText(0,n4_NGame.height / 3,"Square Showdown",60);
		titleText.screenCenter(n4_util_NAxes.X);
		this.add(titleText);
		var howToStartText = new n4e_ui_NEText(0,n4_NGame.height * 0.5,"Press RETURN to play",30);
		howToStartText.screenCenter(n4_util_NAxes.X);
...
states_PlayState.prototype = $extend(n4_NState.prototype,{
	...
	,create: function() {
		Registry.PS = this;
		this.player = new sprites_Player(n4_NGame.width / 2,n4_NGame.height / 2);
		this.add(this.player);
		this._enemies = new n4_group_NTypedGroup();
		this.add(this._enemies);
		this.emitter = new n4_effects_particles_NParticleEmitter(240);
		this.add(this.emitter);
		n4_NState.prototype.create.call(this);
	}
	,update: function(dt) {
		n4_NState.prototype.update.call(this,dt);
		n4_NGame.overlap(this._enemies,this._enemies,$bind(this,this.enemyColision));
		n4_NGame.overlap(this._enemies,this.player,$bind(this,this.playerColision));
		if(this.player.x < 0) {
			this.player.set_x(0);
		}
		if(this.player.x > n4_NGame.width - this.player.get_width()) {
			this.player.set_x(n4_NGame.width - this.player.get_width());
		}
		if(this.player.y < 0) {
			this.player.set_y(0);
		}
		if(this.player.y > n4_NGame.height - this.player.get_height()) {
			this.player.set_y(n4_NGame.height - this.player.get_height());
		}
		this._enemies.forEachActive(function(enemy) {
			if(enemy.x < 0) {
				enemy.set_x(0);
			}
			if(enemy.x > n4_NGame.width - enemy.get_width()) {
				enemy.set_x(n4_NGame.width - enemy.get_width());
			}
			if(enemy.y < 0) {
				enemy.set_y(0);
			}
			if(enemy.y > n4_NGame.height - enemy.get_height()) {
				enemy.set_y(n4_NGame.height - enemy.get_height());
			}
		});
		this.spawnTimer += dt;
	...
	,playerColision: function(b,p) {
		p.set_x((Math.random() * 0.8 + 0.1) * n4_NGame.width);
		p.set_y((Math.random() * 0.8 + 0.1) * n4_NGame.height);
		var _g = 0;
		while(_g < 35) {
			++_g;
			Registry.PS.emitter.emitSquare(b.x,b.y,9,n4_effects_particles_NParticleEmitter.velocitySpread(100,p.velocity.x / 2,p.velocity.y / 2),n4_util_NColorUtil.randCol(0.3,0.3,0.3,0.9),0.8);
		}
		var _g1 = 0;
		while(_g1 < 27) {
			++_g1;
		...
		b.destroy();
		if(!this.player.spedUp) {
			if(!this.player.spedUp) {
				n4_NGame.switchState(new states_GameOverState(this.enemiesKilled));
			}
			p.destroy();
		}
	}
	,enemyColision: function(b,p) {
		if(b == p) {
			return;
		}
		p.set_x((Math.random() * 0.8 + 0.1) * n4_NGame.width);
...
kha_CompilerDefines["source-header"] = "Generated by Haxe 3.4.0 (git build master @ 36ebffa)";
kha_CompilerDefines.sys_g3 = "1";
kha_CompilerDefines.sys_a1 = "1";
kha_CompilerDefines.haxe_ver = "3.4";
...
n4_NEntity.SEPARATE_BIAS = 4;
n4_NEntity.LEFT = 1;
n4_NEntity.RIGHT = 16;
n4_NEntity.UP = 256;
n4_NEntity.DOWN = 4096;
n4_NEntity.NONE = 0;
n4_NEntity.CEILING = 256;
n4_NEntity.FLOOR = 4096;
n4_NEntity.WALL = 17;
n4_NEntity.ANY = 4369;
n4_NEntity._firstSeparateNRect = new n4_math_NRect();
n4_NEntity._secondSeparateNRect = new n4_math_NRect();
n4_NGame.currentState = new n4_NState();
n4_NGame.drawFrameCount = 0;
n4_NGame.updateFrameCount = 0;
